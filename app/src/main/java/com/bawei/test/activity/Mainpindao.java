...
import com.bawei.test.adapter.DragAdapter;
import com.bawei.test.adapter.OtherAdapter;
import com.bawei.test.view.DragGridView;
import com.bawei.test.view.MyGridView;
 ...
 * 1. 类的用途
 * 2. @author $Yuminze
 * 3. @date 2017/2/25 10:36
 */
public class Mainpindao extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_pindao);
        initView();
    }
